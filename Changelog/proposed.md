...
- AsmodeusCore (1.12.2-0.0.26 > 1.12.2-1.0.1)  
...
- Dynamic Surroundings (1.12.2-3.6.2.1 > 1.12.2-3.6.1.0)  
...
- Galaxy Space [Addon for GalactiCraft] (1.12.2-2.0.16 > 1.12.2-2.1.3)  
- JourneyMap (1.12.2-5.7.1 > 1.12.2-5.7.1p1)
- Just Enough Items (JEI) (1.12.2-4.16.1.302 > 1.12.2-4.16.1.1004)  
...
- MixinBooster (8.9 > 9.1)
- More Planets - Galacticraft Add-on (1.12.2-2.2.1-GC280 > 1.12.2-2.3.3-GC4.0.6)  
- Placebo (1.12.2-1.6.0 > 1.12.2-1.6.1)  
- Railcraft (12.0.0 > 12.1.0-beta-8)  
- SteveKunG's Lib (Lib-1.12.2-1.1.10 > mc1.12.2-v1.3.1)  
